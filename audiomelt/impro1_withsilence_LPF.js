...
(function () {
  ...
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME = "impro1_withsilence_LPF.data";
    var REMOTE_PACKAGE_BASE = "impro1_withsilence_LPF.data";
    if (
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_impro1_withsilence_LPF.data");
      }
      Module["addRunDependency"]("datafile_impro1_withsilence_LPF.data");
  ...
  loadPackage({
    files: [{ filename: "/w.wav", start: 0, end: 5720256, audio: 1 }],
    remote_package_size: 5720256,
  });
})();
...
var wasmBinaryFile;
wasmBinaryFile = "impro1_withsilence_LPF.wasm";
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    Module["asm"] = exports;
    wasmMemory = Module["asm"]["Ud"];
    updateGlobalBufferAndViews(wasmMemory.buffer);
    wasmTable = Module["asm"]["Yd"];
    addOnInit(Module["asm"]["Vd"]);
...
var asmLibraryArg = {
  ...
  _: _emscripten_glGenVertexArraysOES,
...
var _malloc = (Module["_malloc"] = function () {
  return (_malloc = Module["_malloc"] = Module["asm"]["Wd"]).apply(
    null,
    arguments
  );
});
...
var stackSave = (Module["stackSave"] = function () {
  return (stackSave = Module["stackSave"] = Module["asm"]["_d"]).apply(
    null,
    arguments
  );
});
var stackRestore = (Module["stackRestore"] = function () {
  return (stackRestore = Module["stackRestore"] = Module["asm"]["$d"]).apply(
    null,
    arguments
  );
});
var stackAlloc = (Module["stackAlloc"] = function () {
  return (stackAlloc = Module["stackAlloc"] = Module["asm"]["ae"]).apply(
    null,
    arguments
  );
});
var dynCall_jiji = (Module["dynCall_jiji"] = function () {
  return (dynCall_jiji = Module["dynCall_jiji"] = Module["asm"]["be"]).apply(
    null,
    arguments
  );
});
var dynCall_ji = (Module["dynCall_ji"] = function () {
  return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["ce"]).apply(
    null,
    arguments
  );
});
